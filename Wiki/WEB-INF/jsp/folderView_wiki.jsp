...
<link rel="stylesheet" type="text/css" href="<%=fullUrl %>css/mainwikistyles.css" />
...
<div id="maix-wiki">
	 	  ...
	 	  <div style="left:40px;">
		      <h2>${ssBinder.title}
			      			      <a class="ss_linkButton" target="_blank" href='<ssf:url operation="modify" action="modify_binder" binderId="${ssBinder.id}">
								   		 	...
								   		 	<img src="<%=fullUrl %>pics/edit.png"/ width="16px" height="16px" target="_blank" /></a></h2>			      
		      </h2>
	...
	<div id="col1">
		 <div class="logo" style="position: absolute;">
	 	 	<img width="32px" height="32px" src="<%=fullUrl %>pics/wikibooks.png" />
	 	 </div>
	 	  <div style="left:40px;">
			...
			<ssf:param name="binderType" value="folder" />
              	</ssf:url>'> <img src="<%=fullUrl %>pics/folder_add_256.png"/ width="18px" height="18px" /> <strong> Ajouter une nouvelle rubrique </strong></p></a>
		   ...
		   <div >
		      	<ul style="margin: 0; padding: 0;">
							   ...
							   ><c:out value="${blogPage.title}" escapeXml="true" />	</a> 
							   	 <a class="ss_linkButton" target="_blank" href='<ssf:url operation="modify" action="modify_binder" binderId="${blogPage.id}">
								  		 	<ssf:param name="binderType" value="folder" />
								   		 	...
								   		 	<ssf:param name="binderType" value="folder" />
								</ssf:url>'> <img src="<%=fullUrl %>pics/edit.png" width="16px" height="16px" />
								</a>
				 	 ...
				 	 <div class="logo" style="position: absolute;">
		 	 	<img width="35px" height="35px" src="<%=fullUrl %>pics/community-icon.gif" />
		 	 </div>
		 	  <div style="left:40px;">
			      <h2>Membres</h2>
				      <a class="ss_linkButton" target="_blank" href='<ssf:url action="add_team_member" binderId="${ssBinder.id}">
				      	...
				      	<img width="18px" height="18px" src="<%=fullUrl %>pics/addmember.png" />  Ajouter un membre
				      </a>
							...
							<c:forEach var="members"  items="${ssTeamMembers}" >
							 <jsp:useBean id="members" type="java.util.Map.Entry" />
						      <%					      				      
									...
									%>			
										<li style="list-style: none;  vertical-align: middle;" class="members"><img src="<%=fullUrl %>pics/usericon.png" width="16px" height="16px" /> <label style="margin-bottom:5px"> <%=members.getKey() %> </label></li>
									<%						
		 	 ...
		 	 <div class="logo" style="position: absolute;">
		 	  ...
		 	  <div style="left:40px;">
			      ...
			      <a class="ss_linkButton" target="_blank" href='<ssf:url operation="modify" action="modify_binder" binderId="${ssBinder.id}">
								   		 	...
								   		 	<img src="<%=fullUrl %>pics/edit.png"/ width="16px" height="16px" /></a></h2>
