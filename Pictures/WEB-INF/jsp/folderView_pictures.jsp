...
<link rel="stylesheet" type="text/css" href="<%=fullUrl %>js/jqueryui/css/ui-darkness/jquery-ui-1.10.0.custom.min.css" />


<script type="text/javascript" src="<html:rootPath/>js/forum/ss_folder.js"></script>
<script type="text/javascript" src="<%=fullUrl %>/js/jqueryui/js/jquery-1.9.0.js"></script>
<script type="text/javascript" src="<%=fullUrl %>/js/jqueryui/js/jquery-ui-1.10.0.custom.min.js"></script>
...
<script type="text/javascript">
	...
	function ConfirmDialog(message, binderId, entryId){

		var url = "/ssf/a/do?p_name=ss_forum&p_action=1&operation=delete&entryType=${entryDef.id}&binderId="+binderId+"&action=modify_folder_entry&entryId="+entryId+"&vibeonprem_url=1";
								...
								<script type="text/javascript">         
									...
									$(document).ready(function(){
									    ...
									    $("a#deleteButton_${entry._docId}").click(function(){		
										    		ConfirmDialog("Are you sure", "${ssBinder.id}", "${entry._docId}");									   									   		 });
